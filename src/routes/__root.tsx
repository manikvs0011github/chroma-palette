...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Chroma — Color Tools" },
      {
        name: "description",
        content:
          "Chroma is a fast color toolkit: pick colors, build palettes, and convert between HEX, RGB, and HSL.",
      },
      { name: "author", content: "Chroma" },
      { property: "og:title", content: "Chroma — Color Tools" },
      {
